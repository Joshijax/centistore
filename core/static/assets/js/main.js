(function (window, document, $, undefined) {
  ...
  // Calculate the date 24 hours in the future
  let futureDate = new Date(currentDate.getTime() + 24 * 60 * 60 * 1000);

  // Format the future date as a string in YYYY/MM/DD format
  ...
  var axilInit = {
    ...
    methods: function (e) {
      ...
      axilInit.countdownInit(".coming-countdown", futureDateString);
      axilInit.campaignCountdown(".campaign-countdown", futureDateString);
      axilInit.countdownInit(".poster-countdown", futureDateString);
      axilInit.countdownInit(".sale-countdown", futureDateString);
